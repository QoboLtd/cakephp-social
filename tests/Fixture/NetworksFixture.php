...
class NetworksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'oauth_consumer_key' => ['type' => 'text', 'length' => 4294967295, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'oauth_consumer_secret' => ['type' => 'text', 'length' => 4294967295, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'active' => 1,
                'trashed' => null,
                'created' => '2019-01-22 09:42:20',
                'modified' => '2019-01-22 09:42:20',
            ],
        ];
        parent::init();
    }
